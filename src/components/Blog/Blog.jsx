    ...
    return (
        <div className='px-6 md:px-14 py-20'>
            <div className='flex md:items-center'>
                <Squares2X2Icon className='w-10 md:w-6 h-6 mr-4 text-[#632ef5]' />
                <h2 className='text-3xl font-bold'>When should you use context API?</h2>
            </div>
            <div className='flex py-4'>
                <ArrowRightIcon className='w-40 md:w-10 h-6 ml-10 text-[#632ef5]' />
            ...
            <div className='flex py-4'>
                <ArrowRightIcon className='w-20 md:w-6 h-6 ml-10 text-[#632ef5]' />
            ...
            <div className='flex md:items-center'>
                <Squares2X2Icon className='w-6 mr-4 text-[#632ef5]' />
